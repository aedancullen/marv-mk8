...
//@Autonomous(name="VisionTest - Cryptobox NJ")
public class VisionTestCryptoboxNJ extends OpMode {
    ...
    public void start() {
        processor.start();
        ObjectSpec beacon = new ObjectSpec(hardwareMap.appContext, "haarcascade_evolution_cryptoboxnj_2k3k_19st", 6.1);
