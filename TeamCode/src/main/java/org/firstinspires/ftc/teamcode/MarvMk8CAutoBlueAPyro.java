...
@Autonomous(name="PYRO Auto Blue A")
public class MarvMk8CAutoBlueAPyro extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        mbxTracker = new AutopilotTrackerMsoSimple(marv.sonarRx, marv.sonarB, marv.sonarR, MarvNavConstants.MbYOffset, MarvNavConstants.MbXOffset);
