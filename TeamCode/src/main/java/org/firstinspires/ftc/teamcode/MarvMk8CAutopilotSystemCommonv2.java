...
public class MarvMk8CAutopilotSystemCommonv2 extends AutopilotSystem {
    ...
    public AutopilotTracker altTracker;

    public MarvMk8CAutopilotSystemCommonv2(AutopilotTracker tracker, Telemetry telemetry, Context appContext, AutopilotTracker altTracker){
    ...
    public void onSegmentTransition(AutopilotSegment previous, AutopilotSegment next, boolean wasOkayToContinue) {
        ...
        if (next != null && next.id.equals("__start__")){
            ...
            // Sonar init position into dead-reckoning tracker
            this.altTracker.update();
            this.host.setRobotPosition(this.altTracker.getRobotPosition());
